          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
            ...
            <div className="space-y-6">
              ...
              <p className="text-sm leading-relaxed">
                At Elevates, we blend fashion with comfort, offering trendy and affordable clothing for every style. Whether you're dressing up or keeping it casual, our collection is designed to make you feel confident, stylish, and uniquely you.
              </p>
